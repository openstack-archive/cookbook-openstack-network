...
# ============================= Nuage Networks Configuration ===============

# ----------------------------- Nuage VRS configuration --------------------

# VRS Active Controller (Active VSC IP Address)
default['openstack']['network']['nuage']['active_controller'] = nil

# VRS Standby Controller (Stanby VSC IP Address)
default['openstack']['network']['nuage']['standby_controller'] = nil

# ----------------------------- Nuage Metadata configuration ---------------

# METADATA_PORT: TCP Port used by Nuage metadata agent
default['openstack']['network']['nuage']['metadata_port'] = '9697'

# NOVA_CLIENT_VERSION
default['openstack']['network']['nuage']['nova_client_version'] = '2'

# NUAGE_METADATA_AGENT_START_WITH_OVS: if nuage-metadata-agent needs to be started with nuage-openvswitch-switch
default['openstack']['network']['nuage']['metadata_start_with_vrs'] = 'true'

# NOVA_API_ENDPOINT_TYPE: one of publicURL, internalURL, adminURL
default['openstack']['network']['nuage']['nova_api_endpoint_type'] = 'internalURL'

# ----------------------------- Nuage Networks plugin configuration --------

# Desired Name of VSD Organization/Enterprise to use
default['openstack']['network']['nuage']['default_net_partition_name'] = 'OpenStack_default'

# Hostname or IP address and port for connection to VSD server (eg. 10.0.0.10:8443)
default['openstack']['network']['nuage']['server'] = nil

# VSD Username and password for OpenStack plugin connection
# User must belong to CSP CMS group
default['openstack']['network']['nuage']['serverauth']['username'] = nil
default['openstack']['network']['nuage']['serverauth']['password'] = nil

# CMS ID generated by Nuage VSD
default['openstack']['network']['nuage']['cms_id'] = nil

# Default configuration for standard installs
default['openstack']['network']['nuage']['organization'] = 'csp'
default['openstack']['network']['nuage']['auth_resource'] = '/me'
default['openstack']['network']['nuage']['serverssl'] = 'True'
default['openstack']['network']['nuage']['base_uri'] = '/nuage/api/v3_2'
...
when 'fedora', 'rhel' # :pragma-foodcritic: ~FC024 - won't fix this
  default['openstack']['network']['platform'] = {
    ...
    'compute_nuage_packages' => ['nuage-metadata-agent', 'nuage-openvswitch'],
    'neutron_server_nuage_packages' => ['nuage-openstack-neutron', 'nuage-openstack-neutronclient', 'nuagenetlib'],
    'package_overrides' => ''
  }
when 'suse'
  default['openstack']['network']['platform'] = {
    ...
    'neutron_hyperv_packages' => ['networking-hyperv'],
    'compute_nuage_packages' => [],
    'neutron_server_nuage_packages' => [],
    'package_overrides' => ''
  }
when 'debian'
  default['openstack']['network']['platform'] = {
